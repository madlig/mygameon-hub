...
function getExpiryLabel(option, customDays) {
  ...
  const date = new Date()
  date.setDate(date.getDate() + days)
  return `Akses hingga ${date.toLocaleDateString('id-ID', { day: 'numeric', month: 'short', year: 'numeric' })}`
}
...
export default function SearchPage() {
  ...
  return (
    <div>
      ...
      {/* Cart bar */}
      {cart.length > 0 && (
        <div className="fixed bottom-20 left-4 right-4 z-40 md:bottom-4 md:left-64 md:right-4 flex flex-col gap-2">
